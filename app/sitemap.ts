...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/best-ai-tools-for-youtube`,       lastModified: now, changeFrequency: 'weekly',   priority: 0.9 },
    { url: `${BASE_URL}/best-free-ai-tools`,              lastModified: now, changeFrequency: 'weekly',   priority: 0.9 },
